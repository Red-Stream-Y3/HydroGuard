  ...
  return (
    <div id='research-problem-solution' className='py-6 lg:py-16'>
      <div className='mx-auto max-w-7xl px-6 lg:px-8'>
        ...
        <div className='mx-auto mt-2 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 pt-10 sm:mt-2 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3'>
          {items.map((post) => (
            <article
              key={post.id}
